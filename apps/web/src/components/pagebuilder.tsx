...
import { TestimonialListBlock } from "./sections/testimonial-list";
import { FeaturedTestimonialBlock } from "./sections/featured-testimonial";
import { BriefServicesDescriptionBlock } from "./sections/brief-services-description";
import { PricesBlock } from "./sections/prices";
import { AboutMe } from "./sections/about-me";
import { MySpecialities } from "./sections/my-specialities";
...
const BLOCK_COMPONENTS = {
  ...
  briefServicesDescription: BriefServicesDescriptionBlock,
  prices: PricesBlock,
  aboutMe: AboutMe,
